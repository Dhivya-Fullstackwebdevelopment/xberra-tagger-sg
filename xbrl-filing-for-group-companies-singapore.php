...
$page_title = "XBRL Filing for Group Companies Singapore | Consolidated XBRL ACRA | Xberra Tagger";

$page_meta = "Full XBRL consolidated filing for Singapore group companies and holding structures. Standalone and consolidated XBRL handled by specialists. 2–3 day turnaround, zero amendment fees.";

$page_keywords = "consolidated XBRL Singapore, XBRL group companies Singapore, XBRL holding company ACRA, full XBRL consolidated Singapore, ACRA group filing XBRL";

$canonical_url = "https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore";

$og_title="XBRL Filing for Group Companies Singapore | Consolidated XBRL";

$og_desc="Consolidated and standalone XBRL for Singapore group companies. Specialist handling, zero amendment fees, 100% ACRA acceptance.";

$og_type="website";

$og_url="https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore";

$twitter_title="Consolidated XBRL for Group Companies Singapore | Xberra Tagger";

$twitter_desc="Full XBRL consolidated filing for Singapore holding companies and group structures.";
 
$full_url="https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore";
$full_default="https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore";
...
{ 
  ...
  "@graph": [ 
    ...
    { 
      ...
      "@id": "https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore#webpage", 

      "url": "https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore", 

      "name": "XBRL Filing for Group Companies Singapore | Consolidated XBRL ACRA | Xberra Tagger", 

      "description": "Full XBRL consolidated filing for Singapore group companies and holding structures. Standalone and consolidated XBRL handled by specialists. 2–3 day turnaround, zero amendment fees.", 
      ...
      "breadcrumb": { 
        ...
        "@id": "https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore#breadcrumb" 
    ...
    { 
      ...
      "@id": "https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore#service", 

      "name": "XBRL Filing for Group Companies Singapore", 
      ...
      "description": "Full XBRL Consolidated and Standalone filing for Singapore group companies and holding structures. Specialist handling with zero amendment fees and 100% ACRA acceptance guarantee.", 
      ...
      "offers": { 
        ...
        "description": "Consolidated XBRL quoted on request. Contact for group pricing.", 
    ...
    { 
      ...
      "itemListElement": [ 
        ...
        { 
          ...
          "item": "https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore" 
    ...
    { 
      ...
      "@id": "https://xberratagger.com.sg/xbrl-filing-for-group-companies-singapore#faq", 
      ...
      "mainEntity": [ 
        ...
        { 
          ...
          "name": "What is the difference between Simplified XBRL and Full XBRL? Which does my company need?", 

          "acceptedAnswer": { 

            "@type": "Answer", 

            "text": "Simplified XBRL covers only Financial Statement Highlights — key balance sheet and income figures. It applies to companies that meet at least 2 of these 3 criteria: annual revenue ≤ S$10M, total assets ≤ S$10M, or 50 or fewer employees. Full XBRL involves complete tagging of your financial statements and applies to larger private companies. We confirm which type applies to your company before we start." 
        ...
        { 
          ...
          "name": "Can you handle consolidated XBRL for group structures?", 

          "acceptedAnswer": { 

            "@type": "Answer", 

            "text": "Yes. We handle all three XBRL types ACRA requires: Simplified XBRL, Full XBRL Standalone (single entity), and Full XBRL Consolidated (group filings). For consolidated accounts, we work from your group financial statements and produce the correctly structured XBRL package for ACRA submission." 
        ...
        { 
          ...
          "name": "Do you submit to ACRA directly, or does our finance team need to do that?", 

          "acceptedAnswer": { 

            "@type": "Answer", 

            "text": "We submit directly to ACRA\'s BizFile portal on your company\'s behalf. Your finance team does not need an ACRA account, BizFile access, or any portal credentials. Once you approve the completed XBRL package, we handle the transmission and deliver the official ACRA filing confirmation to you." 
        ...
        { 
          ...
          "name": "What if our auditors revise the financial statements after you have started conversion?", 

          "acceptedAnswer": { 

            "@type": "Answer", 

            "text": "We update the XBRL file to reflect the revised financials at zero additional charge, regardless of how many revision cycles are required. This applies whether the revision is a minor number correction or a material restatement of the accounts. Our amendment policy is unconditional." 
        ...
        { 
          ...
          "acceptedAnswer": { 
            ...
            "text": "Private companies incorporated in Singapore must file annual financial statements with ACRA within 7 months of their financial year-end. Listed companies have a 5-month window. We recommend engaging us at least 3–4 weeks ahead of your deadline to allow time for document preparation, conversion, and any revision rounds." 
        ...
        { 
          ...
          "name": "Can we switch to Xberra Tagger if we have already started the XBRL conversion elsewhere?", 

          "acceptedAnswer": { 

            "@type": "Answer", 

            "text": "Yes. If you have started with another provider or tried to handle it in-house and encountered problems, we can take over from wherever the process currently stands. Contact us with your situation and we will assess what has been done, what is needed, and give you a clear picture of what we can do and how quickly." 
...
@media (max-width: 1400px) and (min-width: 1251px) {
    .gar-left h2 { font-size: 34px; }
}
@media (max-width: 1250px) {
    .gar-left h2 { font-size: clamp(24px, 3vw, 34px); }
}
...
@media (max-width: 1400px) and (min-width: 1251px) {
    .process-left h2 { font-size: 30px; }
}
@media (max-width: 1250px) {
    .process-left h2 { font-size: clamp(22px, 2.8vw, 30px); }
}
...
@media (max-width: 1400px) and (min-width: 1251px) {
    .proof-left h2 { font-size: 34px; }
}
@media (max-width: 1250px) {
    .proof-left h2 { font-size: clamp(24px, 3vw, 34px); }
}
...
@media (max-width: 1250px) {
    .pr-n { font-size: clamp(30px, 3.5vw, 40px); }
}
...
@media (max-width: 1250px) {
    .cta-l h2 { font-size: clamp(22px, 2.8vw, 30px); }
}

/* Vertical timeline headings */
.vt-body h3 {
    font-size: 16px;
}
@media (max-width: 1400px) and (min-width: 1251px) {
    .vt-body h3 { font-size: 15px; }
}
@media (max-width: 1250px) {
    .vt-body h3 { font-size: clamp(13px, 1.2vw, 15px); }
}
...
@media (max-width: 1250px) {
    .t-quote { font-size: clamp(12px, 1.1vw, 13.5px); }
}
</style>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-12 fade">
                <ul class="breadcrumb-custom">
                    <li><a href="./">Home</a></li>
                    <li><span>For Group Companies</span></li>
                </ul>

                <h1 class="banner-title mb-4">
                    XBRL Filing Your <span class="text-primary-red">Group Company</span> Can Rely On. Every Single Year.
                </h1>

                <p class="text-white-70 lead mb-5">
                    Your Group Company has an annual obligation to file financial statements with ACRA in XBRL format. The question isn't whether to file — it's whether to handle it in-house, piece it together, or trust a proven specialist. Here's why companies choose Xberra Tagger.
                </p>
            ...
            <div class="col-lg-5 col-12 mt-5 mt-lg-0 fade">
                <div class="hero-pricing-card">
                    ...
                    <div class="price-row">
                        <span>Standard</span>
                        <strong>ACRA Taxonomy</strong>
                    </div>
                    <div class="price-row">
                        <span>Format</span>
                        <strong>XBRL (Machine-Readable)</strong>
                    </div>
                    <div class="price-row">
                        <span>Frequency</span>
    ...
    <div class="container">
        <div class="guarantee-inner">
            <div class="gar-left fade">
                ...
                <p>These are not marketing claims. They are the operational commitments every Xberra Tagger client receives — regardless of group  company size, filing type, or portfolio volume.</p>
            </div>
            ...
            <div class="vtl fade">
                ...
                <div class="vt-step">
                    ...
                    <div class="vt-body">
                        ...
                        <p>Our XBRL specialists convert your financial statements to XBRL format, applying the correct ACRA taxonomy tags for your group  company type — Simplified, Full Standalone, or Consolidated. Every file is validated against BizFile before we deliver it for your review.</p>
                ...
                <div class="vt-step">
                    ...
                    <div class="vt-body">
                        ...
                        <p>We transmit the approved XBRL directly to ACRA through BizFile on your group company's behalf. You don't need an ACRA account, BizFile login, or any portal access. Once ACRA processes the filing — typically the same day — we deliver the official filing confirmation to you.</p>
                ...
                <div class="proof-stats">
                    ...
                    <div class="pr-stat">
                        ...
                        <div class="pr-info">
                            ...
                            <p>Across 500+ Reviews from group  company directors, finance managers, and corporate secretaries</p>
                        </div>
                    </div>
                    <div class="pr-stat">
    ...
    <div class="container">
        <div class="d-flex align-items-end justify-content-between flex-wrap gap-3 mb-5">
            <div class="fade">
                ...
                <p class="text-muted-custom">From CFOs to finance managers to company directors — across all group  company sizes.</p>
            </div>
    ...
    <div class="container">
        <div class="faq-inner">
            <div class="fade">
                ...
                <h2 class="section-title">Questions from Group Company Decision-Makers</h2>
                ...
                <div class="faq-cta-box">
                    <p>Have a specific question about your group  company's situation? Our team responds within 30 minutes.</p>
...
<section class="cta-split">
    <div class="cta-l">
        ...
        <p>Tell us about your group  company — type, financial year-end, XBRL requirement — and we'll confirm the approach, turnaround, and rate before you commit to anything.</p>
        <div class="cta-btns">
    ...
    <div class="container">
        <div class="bg-blue p-lg-5 p-4 rounded-5 text-center fade">
            ...
            <p class="cta-desc text-white mb-4">
                Ensure your group  company's compliance with Xberra Tagger. Contact us today for a free trial or a custom quote — no XBRL expertise required.
            </p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const buttons = document.querySelectorAll('.aq');
    ...
    buttons.forEach((button, index) => {
        button.addEventListener('click', function () {
            ...
            document.querySelectorAll('.aa').forEach((ans, i) => {
                if (i !== index) {
