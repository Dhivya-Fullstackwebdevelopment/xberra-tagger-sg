...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T7P5N74C" height="0" width="0"
    ...
    <header class="main-header">
        ...
        <div class="header-container">
            ...
            <div class="logo">
                <a href="../">
                    <img src="../assets/img/home-page/xberra-Logo.png"
                        alt="Xberra Tagger — XBRL Filing Services Singapore" />
                </a>
            </div>
            ...
            <nav class="nav-menu" id="navMenu">
                <ul>
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li><a href="../xbrl-filing-services-for-accounting-firms-singapore">Accounting Firms</a>
                            </li>
                            <li><a href="../xbrl-filing-for-corporate-secretaries-singapore">Corporate Secretaries</a>
                            </li>
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="../acra-xbrl-filing-deadline-calculator">ACRA XBRL Filing Deadline
                                    Calculator</a></li>
                        </ul>
                    </li>
